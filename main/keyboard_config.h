...
#define ENCODER2_A_PIN GPIO_NUM_32 // encoder phase A pin
#define ENCODER2_B_PIN GPIO_NUM_33 // encoder phase B pin
...
#define LK_DEFAULT_NUM 3
#define LK_EMPTY_SEQ_NUM 255
